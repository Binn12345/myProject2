...
@section('profileindex')
    <div class="p-4 sm:ml-64">
        ...
        <div class="grid lg:grid-cols-4 gap-2 grid-cols-1 lg:mb-5">
            ...
            <div class="w-full lg:max-w-full mt-12 bg-white border border-gray-200 rounded-lg shadow bg-gray-800 border-gray-300">
