            ...
            <div class="flex items-center ml-3">
              ...
              <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700" id="dropdown-user">
                ...
                <ul class="py-1" role="none">
                  <li>
                    <a href="{{route('profile')}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600" role="menuitem">Profile</a>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <a type="button" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 cursor-pointer" role="menuitem" id="logout">Sign out</a>
                  </li>
                </ul>
              </div>
            </div>
